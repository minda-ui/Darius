...
| `Raw/td-4210d_4410d_4420dn_4520dn_uke_ug_a.pdf` | 2026-09-17 | partial | none yet | Brother TD-4420DN label-printer User's Guide (covers TD-4210D/4410D/4420DN/4520DN). **Only pages 1-77 of 128 extracted** — the Specifications appendix, Routine Maintenance and Troubleshooting did not come through. Confirms direct thermal, LAN on the DN, 832-dot print width, media handling and Brother's own fade/dust warnings; **no mention of ZPL anywhere**, contradicting reseller listings. Printer not registered as an asset — awaiting its invoice before a code is assigned. |
| `Raw/Fishbone Drylining Ltd Mail - Order Receipt SOA2606351.pdf` | 2026-09-17 | partial | none yet | Printerland order receipt, 9 May 2024, for the Brother TD-4420DN (£211.58 ex VAT) plus two direct-thermal die-cut label rolls (102×50mm, 102×152mm); total £277.92 inc VAT. **Establishes acquisition year 2024**, so the code would be `FA2401`, not an `FA26xx` guess. **Not registered**: ordered from the Fishbone Drylining mailbox, invoiced to Mindaugas Gaudiesius personally at a residential address, shipped to Fishbone Waste at Unit 31 — four parties, none of them AMFA, and the workshop location is assumed not confirmed. It is an order receipt, not the invoice ("an invoice will also follow"). Cited in `Outputs/2026-09-17-handoff-workshop-assets-for-group-register.md`. |
