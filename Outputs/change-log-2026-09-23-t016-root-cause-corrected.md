...
**`Outputs/kb-registers.md` 73,220 → 19,607 B** and **`Outputs/change-log-index.md` 46,462 → 9,172 B**,
with everything settled preserved in two dated snapshots:

| File | Bytes | Holds |
|---|---|---|
| `Outputs/kb-registers.md` | 19,607 | 9 open Processed items, plus every Wiki-structure and Outputs row since the snapshot |
